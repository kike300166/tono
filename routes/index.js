...
router.post('/login2', function(req, res, next){
  ...
  .then(datos=>{
    ...
    if (password == concat){
      ...
      res.render('loginfailcliente', {title: 'Login Fail Cliente'})
    }
  })
})
...
router.post('/register', function(req, res, next){
  ...
  productosModel
    ...
    .then(idClienteRegistrado=>{
      const mailOptions = { 
        from: 'Flashfotografy@gmail.com', 
        to: email, 
        subject: `Bienvenido a Flashfotografy`, 
        text: `Hola!!\n 
        ¡Bienvenido a Flashfotografy!
        Tu registro se efectuo con exito 
      };
  ...
  productosModel
    ...
    .then(datos=>{
      const mailOptions = { 
        ...
        Flashfotografy ©2024 NC. All rights reserved` 
      };
    ...
    const data = JSON.parse(JSON.stringify(response.data));
      ...
      .then(idFacturaRealizada =>{
        const mailOptions = { 
          ...
          text: `¡Hola, ${nombre}!\n\n 
          ¡Gracias por realizar tu compra en Flashfotografy! Aqui la puedes ver al detalle:\n\n
          N° Transicción: ${transaccion_id}\n
          Producto: ${descripcion}\n
          Cantidad: ${cantidad}\n
          Total Pagado: ${total_pagado}${moneda}\n\n
          ¡Gracias por su compra mi estimado!. Si no ha sido usted el que ha realizado la compra, contactenos a la mayor brevedad posible!\n\n 
          FLashfotografy ©2024 NC. All rights reserved` 
        };
